                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Nama Barang</label>
                                            <div class="controls">
                                                <input name="nama_brg" type="text" id="basicinput" placeholder="Nama barang..." class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="stok_brg" type="text" id="basicinput" placeholder="Stok..." class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="harga_brg" type="text" id="basicinput" placeholder="Harga..." class="span8">
                                            </div>
                                        </div>
