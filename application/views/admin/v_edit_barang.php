                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module-body">
                                    <form class="form-horizontal row-fluid" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Kode Barang</label>
                                            <div class="controls">
                                                <input name="kode_brg" type="text" value="<?php echo $data->kode_brg ?>" id="basicinput" placeholder="Kode barang..." class="span8" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="nama_brg" type="text" value="<?php echo $data->nama_brg ?>" id="basicinput" placeholder="Nama barang..." class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="kat_brg" tabindex="1" data-placeholder="Pilih kategori..." class="span8">
                                                    <?php foreach ($kat2->result_array() as $k2) {
                                                        $id_kat=$k2['id_kat'];
                                                        $nm_kat=$k2['nama_kat'];
                                                        if($id_kat==$data->kat_brg)
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="stok_brg" type="text" value="<?php echo $data->qty_brg;?>" id="basicinput" placeholder="Stok..." class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="harga_brg" type="text" value="<?php echo $data->harga_brg;?>" id="basicinput" placeholder="Harga..." class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                ...
                                                <a href="<?php echo base_url().'admin/barang'?>" class="btn btn-inverse">Kembali</a>
                                            </div>
                                        </div>
